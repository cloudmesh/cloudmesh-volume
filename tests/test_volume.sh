...
#
#echo "### Running tests for google"
#cms set cloud=google
#echo aws > ./tests/volume_google.log
#echo "### Starting vm"
#pytest --capture=no -v tests/test_01_setup.py >> ./tests/volume_google.log
#echo "### Running volume testes"
#pytest --capture=no -v tests/test_02_volume_provider.py >> ./tests/volume_google.log
#echo "### Terminating vm"
